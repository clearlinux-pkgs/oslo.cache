...
Version  : 2.6.1
Release  : 58
URL      : http://tarballs.openstack.org/oslo.cache/oslo.cache-2.6.1.tar.gz
Source0  : http://tarballs.openstack.org/oslo.cache/oslo.cache-2.6.1.tar.gz
Source1  : http://tarballs.openstack.org/oslo.cache/oslo.cache-2.6.1.tar.gz.asc
...
%prep
%setup -q -n oslo.cache-2.6.1
cd %{_builddir}/oslo.cache-2.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600109010
...
cp %{_builddir}/oslo.cache-2.6.1/LICENSE %{buildroot}/usr/share/package-licenses/oslo.cache/294b43b2cec9919063be1a3b49e8722648424779

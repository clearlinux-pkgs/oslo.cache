...
Version  : 1.1.0
Release  : 7
URL      : http://tarballs.openstack.org/oslo.cache/oslo.cache-1.1.0.tar.gz
Source0  : http://tarballs.openstack.org/oslo.cache/oslo.cache-1.1.0.tar.gz

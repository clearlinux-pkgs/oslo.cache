...
Version  : 1.2.0
Release  : 8
URL      : http://tarballs.openstack.org/oslo.cache/oslo.cache-1.2.0.tar.gz
Source0  : http://tarballs.openstack.org/oslo.cache/oslo.cache-1.2.0.tar.gz

...
Version  : 0.9.0
Release  : 5
URL      : http://tarballs.openstack.org/oslo.cache/oslo.cache-0.9.0.tar.gz
Source0  : http://tarballs.openstack.org/oslo.cache/oslo.cache-0.9.0.tar.gz

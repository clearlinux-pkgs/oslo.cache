...
Version  : 0.8.0
Release  : 4
URL      : http://tarballs.openstack.org/oslo.cache/oslo.cache-0.8.0.tar.gz
Source0  : http://tarballs.openstack.org/oslo.cache/oslo.cache-0.8.0.tar.gz
